    ...
    <div className={styles.timeline}>
      <div className={styles.timelineItem}>
        ...
        <div className={styles.experienceDetails}>
          ...
          <p className={styles.jobDescription}>
            Developed scalable web apps using Angular, Django, and MySQL, ensuring optimal performance, security, and user experience.
          </p>
          <p className={styles.jobDescription}>
            Improved response time of the application by mgrating from REST to GraphQL, enabling efficient and flexible data retrieval.
          </p>
          <p className={styles.jobDescription}>
      ...
      <div className={styles.timelineItem}>
        ...
        <div className={styles.experienceDetails}>
          ...
          <p className={styles.jobDescription}>
            Developed a responsive UI using React and CSS Modules, incorporating dynamic dropdowns and real-time search displays to enhance UX. 
          </p>
          <p className={styles.jobDescription}> 
            Incorporated GraphQL endpoints with in a React framework to streamline and optimize data retrieval process.
          </p>
          <p className={styles.jobDescription}>
            Utilized JML annotations to define formal specifications for critical programs, ensuring adherence to intended behaviour and functionality.
          </p>
        </div>
      </div>
      ...
      <div className={styles.timelineItem}>
        ...
        <div className={styles.experienceDetails}>
          ...
          <p className={styles.jobDescription}>
            Launched 20+ RESTful APIs in Ruby on Rails, integrating Microservices, Redis, for scalable and responsive backend infrastructure. 
          </p>
          <p className={styles.jobDescription}>
          ...
          <p className={styles.jobDescription}>
            Implemented automation test suite using Selenium WebDriver, which increased test coverage by 30% and improved test execution time by 50%. 
          </p>
        </div>
      </div>
    </div>
